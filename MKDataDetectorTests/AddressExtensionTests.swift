...
//    }
    ...
    func testLocationExtractionValidAddress() {
        ...
        dataDetectorService.extractLocation(fromAddress: validAddress) { location in
            ...
            XCTAssertEqualWithAccuracy(location!.coordinate.latitude, 37.7858, accuracy: 0.05)
            XCTAssertEqualWithAccuracy(location!.coordinate.longitude, -122.4065, accuracy: 0.05)
        }
    }
